...
//Параметры
define('PASSWORD', '123'); //пароль (желательно поменять на свой). Для запуска скрипта, в браузер введите адрес http://example.com/far.php?password=123, где example.com - адрес вашего сайта, Dr57fd - ваш пароль
...
if ((!empty($_GET['password'])) != PASSWORD) {
...
<head>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            display(document.getElementById('regex'))
        };
        <?php } else { ?>
            ...
            <table border="0">
                <tr<?php echo $err_arr[0]; ?>>
                    ...
                    <td>
                        ...
                        <div class="left">
                            <span class="help"
                                  title="Если отметить этот пункт, то в поле «Текст поиска» можно вводить регулярные выражения">[?]</span>
                            <label for="regex">Искать по маске</label>
                            <input onClick="display(this)"
                                   type="checkbox"<?php echo isset($regex) && $regex == 1 ? ' checked' : ''; ?>
                                   name="regex" id="regex" value="1"/>
                        </div>
                        <div class="right" id="regis-block">
                            <label for="regis">Учитывать регистр</label>
                            <input type="checkbox"<?php echo isset($regis) && $regis == '' ? ' checked' : ''; ?>
                                   name="regis" id="regis" value="1"/>
                        </div>
                        <div class="clear"></div>
                        <div id="regex-block">
                            <span class="help"
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox"<?php echo isset($replace) && $replace == 1 ? ' checked' : ''; ?>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="ext"
                               value="<?php echo isset($_POST['ext']) ? $_POST['ext'] : EXT; ?>"/>
                    </td>
                </tr>
                <tr<?php echo $err_arr[1]; ?>>
                    <td align="right">
                        <span class="help"
                              title="Выберите из списка или введите имя директории, в которой производить поиск, или '.' если поиск в директории, где размещен <?php echo BASE_NAME; ?>">[?]</span>
                        <label>Директория *</label>
                    </td>
                    <td>
                        <div class="tree" id="tree">
                            <div><span onClick="getDirs(this)" title="На уровень выше" rel="..">..</span>
                                <div class="tree-items"><?php echo tree('.'); ?></div>
                            </div>
                        </div>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <input type="submit" onClick="loader()" class="btn btn-success" name="submit"
                               value="Искать\Заменить"/>
                        <div id="loader-block">
                            <div id="loader"></div>
                            Поиск...
                        </div>
